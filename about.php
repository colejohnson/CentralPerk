...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
            <title>About | Central Perk Cafe</title>
    ...
    <body>
        ...
        <div class = "maincontainer">
            <div class = "textcontainer">
                ...
                We also offer many varieties in hot tea by the cup. Black, Green, White, Oolong, Pu-Erh and Herbal are some of the many Teas we                      serve.
            </p>
                    <p>
                ...
                We are not only famous for a cafe from Friends but it is also a great spot to hang out with friends, catch up on some old memories, enjoy the great coffee with some snacks.
                        ...
                        <a href="menu.php";>
                            <h2 style="font-family: 'DadsRecipeRegular', sans-serif; left:20%; font-size:2.5em;"> See our menu!</h2>
                            <a/>
                        </div>
